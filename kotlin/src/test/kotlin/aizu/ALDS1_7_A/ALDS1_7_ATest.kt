...
class ALDS1_7_ATest {
    ...
    fun case1() {
        assertEquals(
            listOf(
                TreeOutput(nodeId = 0, parent = -1, depth = 0, leaves = listOf(1, 4, 10)),
                ...
                TreeOutput(nodeId = 4, parent = 0, depth = 1, leaves = listOf(5, 6, 7)),
                ...
                TreeOutput(nodeId = 10, parent = 0, depth = 1, leaves = listOf(11, 12)),
